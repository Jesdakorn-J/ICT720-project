...
<p>2. As a room owner, I want to see historical PM2.5 data and daily summaries, so that I can evaluate whether the room environment is improving or getting worse over time.</p>
